...
namespace
{
	...
	ApplicationDX12* gApplicationDX12 = 0;
}
...
MainWndProc(HWND hwnd, u32 msg, WPARAM wParam, LPARAM lParam)
{
	...
	return gApplicationDX12->MsgProc(hwnd, msg, wParam, lParam);
}
...
HINSTANCE ApplicationDX12::AppInst()const
{
	return mhAppInst;
}

HWND ApplicationDX12::MainWnd()const
{
	return mhMainWnd;
}

f32 ApplicationDX12::AspectRatio()const
{
	return static_cast<f32>(mClientWidth) / mClientHeight;
}

i32 ApplicationDX12::Run()
{
	MSG msg = { 0 };
...
LRESULT ApplicationDX12::MsgProc(HWND hwnd, u32 msg, WPARAM wParam, LPARAM lParam)
{
	switch (msg)
	{
...
bool ApplicationDX12::InitMainWindow()
{
	WNDCLASS wc;
...
void ApplicationDX12::CalculateFrameStats()
{
