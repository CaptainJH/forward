...
ShaderNodeImplPtr GeomColorNodeHlsl::create()
{
    return std::make_shared<GeomColorNodeHlsl>();
}

void GeomColorNodeHlsl::createVariables(const ShaderNode& node, GenContext&, Shader& shader) const
{
...
void GeomColorNodeHlsl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderStage& stage) const
{
