//***************************************************************************************
// PositionNodeHlsl.cpp by Heqi Ju (C) 2023 All Rights Reserved.
//***************************************************************************************
...
ShaderNodeImplPtr PositionNodeHlsl::create()
{
    return std::make_shared<PositionNodeHlsl>();
}

void PositionNodeHlsl::createVariables(const ShaderNode& node, GenContext&, Shader& shader) const
{
...
void PositionNodeHlsl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderStage& stage) const
{
