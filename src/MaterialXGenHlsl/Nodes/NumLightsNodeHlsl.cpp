...
NumLightsNodeHlsl::NumLightsNodeHlsl()
{
    _hash = std::hash<string>{}(NUM_LIGHTS_FUNC_SIGNATURE);
}

ShaderNodeImplPtr NumLightsNodeHlsl::create()
{
    return std::make_shared<NumLightsNodeHlsl>();
}

void NumLightsNodeHlsl::createVariables(const ShaderNode&, GenContext&, Shader& shader) const
{
...
void NumLightsNodeHlsl::emitFunctionDefinition(const ShaderNode& node, GenContext& context, ShaderStage& stage) const
{
