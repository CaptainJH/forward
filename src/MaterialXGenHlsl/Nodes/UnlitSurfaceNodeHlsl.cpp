...
ShaderNodeImplPtr UnlitSurfaceNodeHlsl::create()
{
    return std::make_shared<UnlitSurfaceNodeHlsl>();
}

void UnlitSurfaceNodeHlsl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderStage& stage) const
{
