...
ShaderNodeImplPtr BitangentNodeHlsl::create()
{
    return std::make_shared<BitangentNodeHlsl>();
}

void BitangentNodeHlsl::createVariables(const ShaderNode& node, GenContext&, Shader& shader) const
{
...
void BitangentNodeHlsl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderStage& stage) const
{
