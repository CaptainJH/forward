...
ShaderNodeImplPtr LightNodeHlsl::create()
{
    return std::make_shared<LightNodeHlsl>();
}

void LightNodeHlsl::createVariables(const ShaderNode&, GenContext& context, Shader& shader) const
{
...
void LightNodeHlsl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderStage& stage) const
{
