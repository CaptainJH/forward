...
ShaderNodeImplPtr TransformVectorNodeHlsl::create()
{
    return std::make_shared<TransformVectorNodeHlsl>();
}

void TransformVectorNodeHlsl::createVariables(const ShaderNode& node, GenContext&, Shader& shader) const
{
...
void TransformVectorNodeHlsl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderStage& stage) const
{
...
const string& TransformVectorNodeHlsl::getMatrix(const string& fromSpace, const string& toSpace) const
{
