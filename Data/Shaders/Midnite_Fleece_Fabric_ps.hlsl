...
cbuffer PublicUniforms_pixel : register(b2)
{
    ...
    float node_multiply_9_in2;
    int node_image_color3_2_layer;
    float3 node_image_color3_2_default;
    int node_image_color3_2_uaddressmode;
    int node_image_color3_2_vaddressmode;
    int node_image_color3_2_filtertype;
    int node_image_color3_2_framerange;
    int node_image_color3_2_frameoffset;
    int node_image_color3_2_frameendaction;
    float2 node_image_color3_2_uv_scale;
    float2 node_image_color3_2_uv_offset;
    int node_image_vector3_12_layer;
    float3 node_image_vector3_12_default;
    int node_image_vector3_12_uaddressmode;
    int node_image_vector3_12_vaddressmode;
    int node_image_vector3_12_filtertype;
    int node_image_vector3_12_framerange;
    int node_image_vector3_12_frameoffset;
    int node_image_vector3_12_frameendaction;
    float2 node_image_vector3_12_uv_scale;
    float2 node_image_vector3_12_uv_offset;
    int node_image_vector3_10_layer;
    float3 node_image_vector3_10_default;
    int node_image_vector3_10_uaddressmode;
    int node_image_vector3_10_vaddressmode;
    int node_image_vector3_10_filtertype;
    int node_image_vector3_10_framerange;
    int node_image_vector3_10_frameoffset;
    int node_image_vector3_10_frameendaction;
    float2 node_image_vector3_10_uv_scale;
    float2 node_image_vector3_10_uv_offset;
    int node_extract_11_index;
    int node_normalmap_space;
    float node_normalmap_scale;
    float node_mix_3_fg;
    float node_mix_3_bg;
    float SR_Midnite_Fleece_Fabric_base;
    float SR_Midnite_Fleece_Fabric_diffuse_roughness;
    float SR_Midnite_Fleece_Fabric_metalness;
    float SR_Midnite_Fleece_Fabric_specular;
    float3 SR_Midnite_Fleece_Fabric_specular_color;
    float SR_Midnite_Fleece_Fabric_specular_IOR;
    float SR_Midnite_Fleece_Fabric_specular_anisotropy;
    float SR_Midnite_Fleece_Fabric_specular_rotation;
    float SR_Midnite_Fleece_Fabric_transmission;
    float3 SR_Midnite_Fleece_Fabric_transmission_color;
    float SR_Midnite_Fleece_Fabric_transmission_depth;
    float3 SR_Midnite_Fleece_Fabric_transmission_scatter;
    ...
    float SR_Midnite_Fleece_Fabric_subsurface;
    float3 SR_Midnite_Fleece_Fabric_subsurface_color;
    float3 SR_Midnite_Fleece_Fabric_subsurface_radius;
    float SR_Midnite_Fleece_Fabric_subsurface_scale;
    float SR_Midnite_Fleece_Fabric_subsurface_anisotropy;
    float SR_Midnite_Fleece_Fabric_sheen;
    float3 SR_Midnite_Fleece_Fabric_sheen_color;
    float SR_Midnite_Fleece_Fabric_sheen_roughness;
    float SR_Midnite_Fleece_Fabric_coat;
    float3 SR_Midnite_Fleece_Fabric_coat_color;
    float SR_Midnite_Fleece_Fabric_coat_roughness;
    float SR_Midnite_Fleece_Fabric_coat_anisotropy;
    float SR_Midnite_Fleece_Fabric_coat_rotation;
    float SR_Midnite_Fleece_Fabric_coat_IOR;
    ...
    float SR_Midnite_Fleece_Fabric_thin_film_IOR;
    float SR_Midnite_Fleece_Fabric_emission;
    float3 SR_Midnite_Fleece_Fabric_emission_color;
    float3 SR_Midnite_Fleece_Fabric_opacity;
    bool SR_Midnite_Fleece_Fabric_thin_walled;
};
Texture2D node_image_color3_2_file : register(t2);
Texture2D node_image_vector3_12_file : register(t3);
Texture2D node_image_vector3_10_file : register(t4);
...
bool3 isGreaterThan(float3 a, float3 b)  
float3 mx_srgb_texture_to_lin_rec709(float3 color)
{
    bool3 isAbove = color > (float3)(0.04045);
...
void NG_extract_vector3(float3 in1, int index, out float out1)
{
...
float4 main(in VertexData input) : SV_Target
{
    ...
    float2 node_texcoord_vector2_8_out = vd.texcoord_0;
    float3 geomprop_Tworld_out = normalize(vd.tangentWorld);
    float3 geomprop_Nworld_out = normalize(vd.normalWorld);
    float3 onthefly_4_out = normalize(vd.normalWorld);
    float3 onthefly_6_out = normalize(vd.tangentWorld);
    float2 node_multiply_9_out = node_texcoord_vector2_8_out * node_multiply_9_in2;
    float3 node_image_color3_2_out = (float3)0.0;
    mx_image_color3(node_image_color3_2_file, node_image_color3_2_layer, node_image_color3_2_default, node_multiply_9_out, node_image_color3_2_uaddressmode, node_image_color3_2_vaddressmode, node_image_color3_2_filtertype, node_image_color3_2_framerange, node_image_color3_2_frameoffset, node_image_color3_2_frameendaction, node_image_color3_2_uv_scale, node_image_color3_2_uv_offset, node_image_color3_2_out);
    float3 node_image_vector3_12_out = (float3)0.0;
    mx_image_vector3(node_image_vector3_12_file, node_image_vector3_12_layer, node_image_vector3_12_default, node_multiply_9_out, node_image_vector3_12_uaddressmode, node_image_vector3_12_vaddressmode, node_image_vector3_12_filtertype, node_image_vector3_12_framerange, node_image_vector3_12_frameoffset, node_image_vector3_12_frameendaction, node_image_vector3_12_uv_scale, node_image_vector3_12_uv_offset, node_image_vector3_12_out);
    float3 node_image_vector3_10_out = (float3)0.0;
    mx_image_vector3(node_image_vector3_10_file, node_image_vector3_10_layer, node_image_vector3_10_default, node_multiply_9_out, node_image_vector3_10_uaddressmode, node_image_vector3_10_vaddressmode, node_image_vector3_10_filtertype, node_image_vector3_10_framerange, node_image_vector3_10_frameoffset, node_image_vector3_10_frameendaction, node_image_vector3_10_uv_scale, node_image_vector3_10_uv_offset, node_image_vector3_10_out);
    float3 node_image_color3_2_out_cm_out = (float3)0.0;
    mx_srgb_texture_to_lin_rec709_color3(node_image_color3_2_out, node_image_color3_2_out_cm_out);
    float node_extract_11_out = 0.0;
    NG_extract_vector3(node_image_vector3_12_out, node_extract_11_index, node_extract_11_out);
    float3 node_normalmap_out = (float3)0.0;
    mx_normalmap(node_image_vector3_10_out, node_normalmap_space, node_normalmap_scale, geomprop_Nworld_out, geomprop_Tworld_out, node_normalmap_out);
    float node_mix_3_out = lerp(node_mix_3_bg, node_mix_3_fg, node_extract_11_out);
